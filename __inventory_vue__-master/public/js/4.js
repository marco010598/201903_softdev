...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Filtering_Filter_vue__ = __webpack_require__(114);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Filtering_categoryStates_js__ = __webpack_require__(16);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            searchQuery: '',
            brandsColumns: ['name'],
            brands: __WEBPACK_IMPORTED_MODULE_3__Filtering_categoryStates_js__["a" /* default */].data,
            layout: 'list',
    ...
    methods: {
        spliceData: function spliceData(data) {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_3__Filtering_categoryStates_js__["a" /* default */].deleteData(data);
            vm.layout = 'list';
        },
        dataReceive: function dataReceive(data) {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_3__Filtering_categoryStates_js__["a" /* default */].dataReceive(data);
            vm.layout = 'list';
        },
        findIndex: function findIndex(data) {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_3__Filtering_categoryStates_js__["a" /* default */].findIndex(data);
            vm.layout = 'edit';
        },
        editPost: function editPost(getImage) {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_3__Filtering_categoryStates_js__["a" /* default */].dataEdit(getImage);
            vm.layout = 'list';
        },
        fetchbrands: function fetchbrands() {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_3__Filtering_categoryStates_js__["a" /* default */].fetch('api/categories');
        }
    }
});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [(_vm.layout == 'edit') ? _c('edit', {
    ...
    attrs: {
      ...
      "dataArray": _vm.brands.categories
    },
    on: {
      "backList": function($event) {
        _vm.layout = 'list'
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-744f8dff", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(13)("2f68d75a", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-744f8dff\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-744f8dff\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
Component.options.__file = "C:\\xampp\\htdocs\\__inventory_vue__-master\\resources\\assets\\js\\components\\Categories\\index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-744f8dff", Component.options)
  } else {
    hotAPI.reload("data-v-744f8dff", Component.options)
  }
})()}
