...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Filtering_ManufacturesStates_js__ = __webpack_require__(14);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            brands: __WEBPACK_IMPORTED_MODULE_3__Filtering_ManufacturesStates_js__["a" /* default */].data,
            layout: 'list',
    ...
    methods: {
        spliceData: function spliceData(data) {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_3__Filtering_ManufacturesStates_js__["a" /* default */].deleteData(data);
            vm.layout = 'list';
        },
        dataReceive: function dataReceive(id, data) {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_3__Filtering_ManufacturesStates_js__["a" /* default */].dataReceive(id, data);
            vm.layout = 'list';
        },
        findIndex: function findIndex(data) {
            console.log(data);
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_3__Filtering_ManufacturesStates_js__["a" /* default */].findIndex(data);
            vm.layout = 'edit';
        },
        editPost: function editPost() {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_3__Filtering_ManufacturesStates_js__["a" /* default */].dataEdit();
            vm.layout = 'list';
        },
        fetchbrands: function fetchbrands() {
            __WEBPACK_IMPORTED_MODULE_3__Filtering_ManufacturesStates_js__["a" /* default */].fetch('api/manufactures');
        }
    }
});
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0d876e35", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(13)("69ee4c71", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-0d876e35\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-0d876e35\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
Component.options.__file = "C:\\xampp\\htdocs\\__inventory_vue__-master\\resources\\assets\\js\\components\\Manufactures\\index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0d876e35", Component.options)
  } else {
    hotAPI.reload("data-v-0d876e35", Component.options)
  }
})()}
