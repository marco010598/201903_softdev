...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        'create-data': __WEBPACK_IMPORTED_MODULE_0__Filtering_create_vue___default.a
    },
    mounted: function mounted() {
        document.title = 'Create ' + this.textData;
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-b2189c38", module.exports)
  }
}
...
Component.options.__file = "C:\\xampp\\htdocs\\__inventory_vue__-master\\resources\\assets\\js\\components\\Descriptions\\create.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] create.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b2189c38", Component.options)
  } else {
    hotAPI.reload("data-v-b2189c38", Component.options)
  }
})()}
