...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        'edit-data': __WEBPACK_IMPORTED_MODULE_1__Filtering_Edit_vue___default.a
    },
    mounted: function mounted() {
        var vm = this;
    ...
    methods: {
        fetchData: function fetchData(dataId) {
            __WEBPACK_IMPORTED_MODULE_1__Filtering_Edit_vue___default.a.fetchObject('../../api/categories/' + dataId + '/edit');
        }
    }
});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "panel-heading"
  }, [_vm._v("Edit " + _vm._s(_vm.textData))]), _vm._v(" "), _c('div', {
    staticClass: "panel-body"
  }, [_c('edit-data', {
    attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-70594d26", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(13)("0dc81db0", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-70594d26\",\"scoped\":false,\"hasInlineConfig\":true}!./noty.css", function() {
     var newContent = require("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-70594d26\",\"scoped\":false,\"hasInlineConfig\":true}!./noty.css");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
Component.options.__file = "C:\\xampp\\htdocs\\__inventory_vue__-master\\resources\\assets\\js\\components\\Categories\\edit.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] edit.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-70594d26", Component.options)
  } else {
    hotAPI.reload("data-v-70594d26", Component.options)
  }
})()}
