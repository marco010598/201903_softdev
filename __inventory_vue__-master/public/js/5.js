...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Filtering_create_vue__ = __webpack_require__(106);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Filtering_brandStates_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Filtering_Filter_vue__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Filtering_Filter_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__Filtering_Filter_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        DemoGrid: __WEBPACK_IMPORTED_MODULE_3__Filtering_Filter_vue___default.a, Create: __WEBPACK_IMPORTED_MODULE_0__Filtering_create_vue___default.a, Edit: __WEBPACK_IMPORTED_MODULE_1__Filtering_Edit_vue___default.a
    },
    data: function data() {
        return {
            ...
            brands: __WEBPACK_IMPORTED_MODULE_2__Filtering_brandStates_js__["a" /* default */].data,
            layout: 'list',
            textData: 'Model',
            urlData: '../api/brands',
            nameData: {
    ...
    methods: {
        spliceData: function spliceData(data) {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_2__Filtering_brandStates_js__["a" /* default */].deleteData(data);
            vm.layout = 'list';
        },
        findIndex: function findIndex(data) {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_2__Filtering_brandStates_js__["a" /* default */].findIndex(data);
            vm.layout = 'edit';
        },
        editPost: function editPost() {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_2__Filtering_brandStates_js__["a" /* default */].dataEdit();
            vm.layout = 'list';
        },
        dataReceive: function dataReceive(id, data) {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_2__Filtering_brandStates_js__["a" /* default */].dataReceive(id, data);
            vm.layout = 'list';
        },
        fetchbrands: function fetchbrands() {
            __WEBPACK_IMPORTED_MODULE_2__Filtering_brandStates_js__["a" /* default */].fetch('api/brands');
        }
    }
});
  ...
  return _c('div', [(_vm.layout == 'edit') ? _c('edit', {
    ...
    on: {
      ...
      "dataName": function($event) {
        return _vm.dataReceive(_vm.nameData.id, $event)
      }
    }
  }) : _vm._e(), _vm._v(" "), (_vm.layout == 'list') ? _c('div', {
    staticClass: "container"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-1a0e94a2", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(13)("a5ae7af8", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-1a0e94a2\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-1a0e94a2\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
Component.options.__file = "C:\\xampp\\htdocs\\__inventory_vue__-master\\resources\\assets\\js\\components\\Brands\\index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1a0e94a2", Component.options)
  } else {
    hotAPI.reload("data-v-1a0e94a2", Component.options)
  }
})()}
