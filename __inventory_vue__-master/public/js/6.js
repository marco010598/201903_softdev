...
Component.options.__file = "C:\\xampp\\htdocs\\__inventory_vue__-master\\resources\\assets\\js\\components\\Transfers\\Add.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-fecdb2ac", Component.options)
  } else {
    hotAPI.reload("data-v-fecdb2ac", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-fecdb2ac", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(13)("0784ac54", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-fecdb2ac\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Add.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-fecdb2ac\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Add.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Loader_Loader_vue__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Loader_Loader_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__Loader_Loader_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Select2_vue__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Select2_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__Select2_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Add_vue__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Add_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__Add_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Noty_notyAlert__ = __webpack_require__(98);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__DataList_vue__ = __webpack_require__(174);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__DataList_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__DataList_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Filtering_brandStates_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Filtering_categoryStates_js__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Filtering_statusStates_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Filtering_actionStates_js__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Filtering_descriptionStates_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Filtering_ManufacturesStates_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__Filtering_locationState_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__Filtering_productStates_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__Filtering_fetchAll_js__ = __webpack_require__(20);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    name: 'createCFAT',
    components: {
        'select2': __WEBPACK_IMPORTED_MODULE_1__Select2_vue___default.a,
        'add': __WEBPACK_IMPORTED_MODULE_2__Add_vue___default.a,
        'loader': __WEBPACK_IMPORTED_MODULE_0__Loader_Loader_vue___default.a,
        'data-list': __WEBPACK_IMPORTED_MODULE_4__DataList_vue___default.a
    },
    ...
    data: function data() {
        return {
            ...
            brands: __WEBPACK_IMPORTED_MODULE_5__Filtering_brandStates_js__["a" /* default */].data,
            categories: __WEBPACK_IMPORTED_MODULE_6__Filtering_categoryStates_js__["a" /* default */].data,
            products: __WEBPACK_IMPORTED_MODULE_12__Filtering_productStates_js__["a" /* default */].data,
            descriptions: __WEBPACK_IMPORTED_MODULE_9__Filtering_descriptionStates_js__["a" /* default */].data,
            manufactures: __WEBPACK_IMPORTED_MODULE_10__Filtering_ManufacturesStates_js__["a" /* default */].data,
            locations: __WEBPACK_IMPORTED_MODULE_11__Filtering_locationState_js__["a" /* default */].data,
            statuses: __WEBPACK_IMPORTED_MODULE_7__Filtering_statusStates_js__["a" /* default */].data,
            actions: __WEBPACK_IMPORTED_MODULE_8__Filtering_actionStates_js__["a" /* default */].data,
            showAddSerial: false,
            selected: [],
    ...
    computed: {
        ...
        actionsFetch: function actionsFetch() {
            var vm = this;
    ...
    methods: {
        inputSerial: function inputSerial(index) {
            var vm = this;
            ...
            for (var i = 0; i < datalist_id.options.length; i++) {
                if (datalist_id.options[i].value == input_id.value) {
                    ...
                    axios.get('../../api/transfers/getSerial/' + value).then(function (response) {
                        vm.addRows[index].serial = response.data.data.serial, vm.addRows[index].quantity = 1, vm.addRows[index].type = response.data.data.type, vm.addRows[index].status = response.data.data.status, vm.addRows[index].action = response.data.data.status == 0 ? 3 : 2, vm.addRows[index].model = response.data.data.brand_id, vm.addRows[index].category = response.data.data.category_id, vm.addRows[index].description = response.data.data.description_id, vm.addRows[index].manufacture = response.data.data.manufacture_id, vm.addRows[index].location = response.data.data.location_id, vm.addRows[index].maxQuantity = response.data.data.quantity;
                    });
                    break;
                }
            }
...
Component.options.__file = "C:\\xampp\\htdocs\\__inventory_vue__-master\\resources\\assets\\js\\components\\Transfers\\DataList.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9ef0eea2", Component.options)
  } else {
    hotAPI.reload("data-v-9ef0eea2", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-9ef0eea2", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [(!_vm.loading) ? _c('table', {
    staticClass: "table table-bordered "
  }, [_c('thead', [(_vm.showAddSerial) ? _c('th', [_vm._v("Type")]) : _vm._e(), _vm._v(" "), _c('th', [_vm._v("Serial")]), _vm._v(" "), _c('th', [_vm._v("Status")]), _vm._v(" "), _c('th', [_vm._v("Action")]), _vm._v(" "), _c('th', [_vm._v("Quantity")]), _vm._v(" "), (_vm.showAddSerial) ? _c('th', [_vm._v("Model")]) : _vm._e(), _vm._v(" "), (_vm.showAddSerial) ? _c('th', [_vm._v("Categories")]) : _vm._e(), _vm._v(" "), (_vm.showAddSerial) ? _c('th', [_vm._v("Description")]) : _vm._e(), _vm._v(" "), (_vm.showAddSerial) ? _c('th', [_vm._v("Manufacture")]) : _vm._e(), _vm._v(" "), _c('th', [_vm._v("Transfer Location")]), _vm._v(" "), _c('th', {
    staticStyle: {
      "text-align": "center"
    }
  }, [_c('a', {
    ...
    return _c('tr', [(_vm.showAddSerial) ? _c('td', [_c('select', {
      directives: [{
        name: "model",
        rawName: "v-model.number",
        value: (addTd.type),
        expression: "addTd.type",
        modifiers: {
          "number": true
        }
      }],
      ...
      on: {
        "change": function($event) {
          ...
          _vm.$set(addTd, "type", $event.target.multiple ? $$selectedVal : $$selectedVal[0])
        }
      }
    }, [_c('option', {
      domProps: {
    ...
    }, [_vm._v("Non-Consumable")]), _vm._v(" "), _c('option', {
      domProps: {
        "value": 0
      }
    }, [_vm._v("Consumable")])])]) : _vm._e(), _vm._v(" "), _c('td', {
      class: {
      ...
      on: {
        "change": function($event) {
          return _vm.inputSerial(index)
        },
        "input": function($event) {
          if ($event.target.composing) { return; }
          _vm.$set(addTd, "createSerial", $event.target.value)
        }
      }
    }), _vm._v(" "), _c('span', {
      staticClass: "input-group-btn"
      ...
      attrs: {
        "options": _vm.productFetch,
        "name": "serial[]",
        "required": ""
      },
      on: {
        "selectValue": function($event) {
          return _vm.validateDuplicate($event, index)
        },
      ...
      model: {
        value: (addTd.product),
        callback: function($$v) {
          _vm.$set(addTd, "product", _vm._n($$v))
        },
    ...
    }, [_vm._v("Duplicated Entry")])]), _vm._v(" "), _c('td', [_c('select2', {
      attrs: {
    ...
    }, [_vm._v("Select one")])])], 1), _vm._v(" "), _c('td', [_c('select2', {
      attrs: {
        "options": _vm.actionsFetch,
        "urlName": "../api/actions",
        "name": "status[]",
        "required": ""
      },
    ...
    }, [_vm._v("Select one")])])], 1), _vm._v(" "), (_vm.showAddSerial) ? _c('td', [_c('input', {
      directives: [{
        name: "model",
        rawName: "v-model.number",
      ...
      on: {
        "input": function($event) {
          if ($event.target.composing) { return; }
          _vm.$set(addTd, "quantity", _vm._n($event.target.value))
        },
        "blur": function($event) {
    ...
    })]), _vm._v(" "), (_vm.showAddSerial) ? _c('td', [_c('div', [_c('select2', {
      attrs: {
    ...
    }, [_vm._v("Select one")])])], 1)]) : _vm._e(), _vm._v(" "), (_vm.showAddSerial) ? _c('td', [_c('div', [_c('select2', {
      attrs: {
      ...
      model: {
        ...
        callback: function($$v) {
          _vm.$set(addTd, "category", _vm._n($$v))
        },
      ...
      model: {
        ...
        callback: function($$v) {
          _vm.$set(addTd, "description", _vm._n($$v))
        },
      ...
      model: {
        ...
        callback: function($$v) {
          _vm.$set(addTd, "manufacture", _vm._n($$v))
        },
      ...
      on: {
        "click": function($event) {
          $event.preventDefault();
          return _vm.removeTD(index)
        }
      }
    }, [_c('i', {
      staticClass: "glyphicon glyphicon-remove"
    })])])])
  }), 0)]) : _c('p', [_vm._v("Sorry, no items found.")]), _vm._v(" "), _c('button', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-cd93d83a", module.exports)
  }
}
...
Component.options.__file = "C:\\xampp\\htdocs\\__inventory_vue__-master\\resources\\assets\\js\\components\\Transfers\\create.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-cd93d83a", Component.options)
  } else {
    hotAPI.reload("data-v-cd93d83a", Component.options)
  }
})()}
